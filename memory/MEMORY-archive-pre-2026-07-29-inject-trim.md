# MEMORY archive — pre-inject-trim (2026-07-29)

This file is the **full pre-trim** copy of root `MEMORY.md` as of 2026-07-29 (~36812 bytes).
Live inject file is now a slim durable subset: `/home/mrbig3/.openclaw/workspace/MEMORY.md`.
Byte-identical body backup also at: `memory/cursor-jobs/backups/MEMORY.md.bak.2026-07-29-pre-inject-trim`.
Do **not** re-inject this archive into main session; use for continuity / search / restore only.
Job: parked ladder #5 (MEMORY.md inject trim). Header-only prefix below; original content starts at the first `## 2026-07-28` heading.
