...
| F04 | Hilltop listing address Chula Vista | 1434 Hilltop Dr, Chula Vista 91911 | WORLD_STATE.md, MEMORY.md, memory/2026-07-11.md | durable_facts |
...
| F06 | Chamber 7 casino prediction market reject | Chamber #7 REJECT both casino and prediction market | MEMORY.md, memory/2026-06-23.md | historical_narrative |
...
| F08 | identity automatic check spam condensed | 173 auto identity checks condensed 2026-07-27 | MEMORY.md, memory/identity-substrate.md, memory/2026-07-27.md | recent_events |
| F09 | FBN publication status Big House | FBN published / Jason clear (or prior proof-held state) | WORLD_STATE.md, MEMORY.md, memory/2026-07-28.md, memory/2026-07-27.md | current_ops |
...
| F11 | Hilltop weekly price cut path until sold | Hilltop policy $5k/week cuts until sells; −$10k cumulative so far | WORLD_STATE.md, MEMORY.md, memory/2026-07-28.md | current_ops |
| F12 | openclaw.json permissions critical patch July 28 | openclaw.json mode 664→600; re-audit 0 critical 2026-07-28 | memory/2026-07-28.md, MEMORY.md, memory/claim-ledger.md | recent_events |
...
| F14 | verified claim language banned success words | Banned without proof: done, fixed, verified, clean, working, pushed, live, shipped | memory/procedural-memory-v1.md, MEMORY.md | procedures |
| F15 | Chamber 9 Obsidian integration decision | Chamber #9 Obsidian Integration: HOLD (unanimous) | MEMORY.md | historical_narrative |
...
Scores **raw** (engine order) and **filtered** (dream/candidates/eval-self dropped, then re-ranked). Per-category rollups included.
