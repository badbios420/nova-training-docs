...
const TTL = 190692122 + 1200; // current tip + 20min
...
const utxoHash = '1ab606a8b093a477e9986a32af457fb8f373efc6f67e8eb982955ccba88c58fc';
const UTXO_AMT = 7831595;
...
inputs.add(CSL.TransactionInput.new(
  CSL.TransactionHash.from_bytes(Buffer.from(utxoHash, 'hex')), 1  // tx_index was 1
));
