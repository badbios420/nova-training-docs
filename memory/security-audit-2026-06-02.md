# Security Audit - 2026-06-02 13:38 PDT
...
- **plugins.installs_unpinned_npm_specs**: Plugin index includes unpinned npm specs (`@openclaw/codex`)
...
## INFO
- **summary.attack_surface**: groups: open=0, allowlist=0
...
**Notes:** Audit completed internally per daily reminder. No user notification sent. Review plugin "lossless-claw" as priority.