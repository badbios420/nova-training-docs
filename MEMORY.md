...
- **7/29–7/30:** Alpha P0/P1 night C1–C6 shipped + lock-in. MEMORY inject trim (#5) 36KB→~7KB. Retrieval filt hit@3 0.60→**0.87**. Workshop tool apply can expire — CLI `openclaw skills workshop apply` is reliable after Jason go/your-call. C7+ parked until opened. Residual retrieval: F09 FBN, F11 Hilltop weekly (ops-first still required).
